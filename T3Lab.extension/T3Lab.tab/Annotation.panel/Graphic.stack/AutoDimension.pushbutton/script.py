...
# __file__ is inside: T3Lab.extension/T3Lab.tab/Annotation.panel/Graphic.stack/AutoDimension.pushbutton/
# Five dirname calls from __file__ reach the T3Lab.extension root.
