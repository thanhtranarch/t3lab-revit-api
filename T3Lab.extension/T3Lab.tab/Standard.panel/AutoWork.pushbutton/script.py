...
if reload:
    if 'GUI.AutoWorkDialog' in sys.modules:
        reload(sys.modules['GUI.AutoWorkDialog'])
    elif 'AutoWorkDialog' in sys.modules:
        reload(sys.modules['AutoWorkDialog'])

from pyrevit import revit
from GUI.AutoWorkDialog import show_auto_work_dialog
...
if __name__ == '__main__':
    ...
    try:
        ...
        pass
    show_auto_work_dialog(doc, uidoc)
